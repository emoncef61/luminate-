"use client"; //useState and useEffect
...
const ImageUpload: FC<ImageUploadProps> = ({
    ...
    //avoid hydration issues use unassigned methode to render on client side
    ...
    if (type == "profile"){
        return <div className="relative rounded-full w-52 h-52 inset-x-96 bg-gray-200 border-2 border-white shadow-2">
           {value.length>0 && (
            <Image 
                src={value[0]} 
                alt="" 
